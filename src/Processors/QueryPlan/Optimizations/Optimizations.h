...
bool optimizeVectorSearchWithCodes(QueryPlan::Node & root, Stack & stack, QueryPlan::Nodes & nodes, const Optimization::ExtraSettings &, size_t max_limit_for_lazy_materialization);
